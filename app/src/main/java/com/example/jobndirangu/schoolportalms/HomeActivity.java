...
import com.example.jobndirangu.schoolportalms.Admin.AdminMaintainEventActivity;
import com.example.jobndirangu.schoolportalms.Model.Events;
import com.example.jobndirangu.schoolportalms.Prevalent.Prevalent;
import com.example.jobndirangu.schoolportalms.ViewHolder.EventViewHolder;
import com.example.jobndirangu.schoolportalms.ViewHolder.EventViewHolder;
...
// change later on activity
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                ...
                {
                    Toast.makeText(HomeActivity.this, "This is end user feature", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    protected void onStart()
    {
        ...
        FirebaseRecyclerOptions<Events> options=
                ...
                .setQuery(EventRef, Events.class)
                .build();
        ...
        FirebaseRecyclerAdapter<Events, EventViewHolder> adapter=
                new FirebaseRecyclerAdapter<Events, EventViewHolder>(options) {
                    ...
                    {
                        holder.txtEventName.setText(model.getEvntname());
                        holder.txtEventDescription.setText(model.getEvntdescription());
                        holder.txtEventDate.setText("Date"+model.getEvntdate()+"year");
...
//        }
    ...
    public boolean onNavigationItemSelected(MenuItem item)
    {
        ...
        else if (id == R.id.fee)
        {
            if(!type.equals("Admin"))
            {
                Intent intent= new Intent(HomeActivity.this,FeeActivity.class);
                startActivity(intent);
            }
        }
